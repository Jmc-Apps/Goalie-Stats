...
The live Worker must contain the supplied benchmark API before app v5.84 can upload benchmark data.
...
7. Open app v5.84, opt in and select Upload Data & Refresh Benchmarks.
