/* Hockey Goalie Stats v5.83 - single-goalie backup, merge and deletion approval. */
(function(){
'use strict';
...
function exportSingleGoalie577(){
  ...
  trackedSaveDB();
  const payload={sourceApp:'Hockey Goalie Stats',sourceVersion:typeof APP_VERSION_566==='string'?APP_VERSION_566:'5.83',exportType:TRANSFER_TYPE,schemaVersion:SCHEMA_VERSION,exportedAt:isoNow(),goalie:prepareTransferGoalie(g)};
